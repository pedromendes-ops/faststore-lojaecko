              ...
              >
                ...
                {type === 'StoreFacetRange' && isExpanded && (
                  <UIFilterFacetRange
                    ...
                    min={facet.min}
                    max={facet.max}
                    // `formatter` is typed as required by @faststore/ui, but the
                    // core component treats it as optional (undefined => default
                    // formatting). Cast keeps the same runtime behavior as core.
                    formatter={
                      (facet.key.toLowerCase() === 'price'
                        ? useFormattedPrice
                        : undefined) as (value: number) => string
                    }
